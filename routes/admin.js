...
router.post(
  ...
  isLogged,
  [
    body("title", "You used forbidden characters.")
      .isString()
      .isLength({ min: 3 })
      .withMessage("The title must the at least 5 characters long."),
...
router.post(
  ...
  isLogged,
  [
    body("title", "You used forbidden signs.")
      .isString()
      .isLength({ min: 3 })
      .withMessage("The title must the at least 5 characters long."),
    body("imageURL", "You entered invalid URL.").isURL(),
...
router.delete("/delete-product/:productId", isLogged, adminContr.deleteProd);
